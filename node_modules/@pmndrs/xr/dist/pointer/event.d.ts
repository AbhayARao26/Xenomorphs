...
export declare function bindXRInputSourceEvent(session: XRSession, inputSource: XRInputSource, event: 'select' | 'selectstart' | 'selectend' | 'squeeze' | 'squeezestart' | 'squeezeend', fn: (event: XRInputSourceEvent) => void): () => void;
