...
} from "./chunk-ADY2MVJL.js";
import {
  createStore
} from "./chunk-657QNAAX.js";
import {
  require_client
...
var FallbackXRLayerImplementation = (0, import_react19.forwardRef)(({ src, renderTargetRef, renderOrder, pixelWidth, pixelHeight, ...props }, ref) => {
...
function useLayerStore(width, height) {
  ...
  (0, import_react19.useEffect)(() => layerStore.setState({
