...
function startEmulate(emulate, alert) {
  var _a, _b;
  Promise.all([(_a = navigator.xr) == null ? void 0 : _a.isSessionSupported("immersive-vr"), (_b = navigator.xr) == null ? void 0 : _b.isSessionSupported("immersive-ar")]).then(([vr, ar]) => !ar && !vr ? import("./emulate-XMDJU54X.js") : void 0).then((pkg) => {
    if (alert) {
