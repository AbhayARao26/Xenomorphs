 ...
 */
export declare function useXRReferenceSpace(): XRSpace;
/**
 * hook that returns a function to compute a matrix that contains the transformation of the provided xr space
 */
export declare function useGetXRSpaceMatrix(space: XRSpace): ((target: import("three").Matrix4, frame: XRFrame | undefined) => void) | undefined;
/**
 ...
 */
export declare function useApplyXRSpaceMatrix(ref: RefObject<Object3D>, space: XRSpace, onFrame?: (state: RootState, delta: number, frame: XRFrame | undefined) => void): void;
