...
export declare function XRLayer({ src, pixelWidth, pixelHeight, renderPriority, children, ...props }: XRLayerProperties): import("react/jsx-runtime").JSX.Element | null;
...
export declare function useLayerStore(width: number, height: number): {
    (): RootState & {
