...
export const showTransformControlsFor = atom(null);

export const cameraParams = atom({});

export const lightNames = atom({});
export const activeLight = atom(null);
export const lightParams = atom({});
