...
import { PerspectiveCamera, useHelper, TransformControls } from '@react-three/drei';
...
export default function PerspectiveCameraWithHelper({ name, camera, isVisible }) {
